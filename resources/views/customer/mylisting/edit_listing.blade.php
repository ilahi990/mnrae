                            ...
                            <form class="basic-form" action="{{ route('updateRealEstateListing', ['id' => $listing->id, 'form' => 'basic']) }}" method="post">
                                ...
                                <div class="dl_column_form d-flex flex-column rg-22">
                                            ...
                                            <div class="dl-gender-wrap d-inline-flex justify-content-between">
                                                ...
                                                <div class="gender-item">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <input type="radio" name="type" class="form-check-input dl-radio" id="sell" value='sale' required

                                                            @if ($listing->type == 'sale') checked @endif /><label for="sell"
                                    ...
                                    <div class="row justify-content-between align-items-center">
                                        ...
                                        <label for="year_build_in" class="col-sm-2 col-eForm-label">Permit Number*</label>
                                ...
                                <div class="dl_column_form d-flex flex-column rg-22">
                                    ...
                                    <div class="row justify-content-between align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" class="form-control eForm-control2" id="meta_title" name="meta_title" placeholder="Type your meta title" value="{{ $listing->meta_title }}"
                                    ...
                                    <div class="row justify-content-between align-items-start">
                                        ...
                                        <label  class="col-sm-3 col-eForm-label" Value="{{ get_phrase('Property Title') }}">{{ get_phrase('Meta Description') }}</label>
                                    ...
                                    <div class="row justify-content-between align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="og_image">
                                                ...
                                                <img src="{{ asset('uploads/seo/'.$listing->og_image) }}" alt="....">
                                            ...
                                            <div class="contact-map">
                                                ...
                                                <div class="map-area">
                                                    ...
                                                    <div class="map-frame">
                                                        ...
                                                        <link rel="stylesheet" href="{{ asset('assets/customer/css/leaflet.css') }}" crossorigin="" />

                                                        <script src="{{ asset('assets/customer/js/leaflet.js') }}" crossorigin=""></script>
                                            ...
                                            <ul class="previous-media">
                                                ...
                                                @foreach ($gallery_image as $img)
                                                    ...
                                                    <li class="uploaded-image">
                                                        ...
                                                        <img id="{{ $img }}" src="{{ asset('uploads/real_estate/galleryImages/' . $img) }}" alt="" />
                                                ...
                                                <ul class="previous-media">
                                                    ...
                                                    @foreach ($additional_gallery as $img)
                                                        ...
                                                        <li class="uploaded-image">
                                                            ...
                                                            <img id="{{ $img }}" src="{{ asset('uploads/real_estate/additionalGallery/' . $img) }}" alt="" />
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <div class="previous-media video-promo">
                                                        ...
                                                        <div class="apnd-img" id="{{ $listing->promo_video . '_upload_vdo' }}">
                                                            ...
                                                            <video autoplay="" muted="" src="{{ asset('uploads/real_estate/video/' . $listing->promo_video) }}"
                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="3d-view w-100">
                                            ...
                                            <script type="module" src="{{ asset('assets/customer/js/model-viewer.min.js') }}"></script>
                                            ...
                                            <model-viewer alt="Neil Armstrong's Spacesuit from the Smithsonian Digitization Programs Office and National Air and Space Museum"
                                                ...
                                                src="{{ asset('assets/uploads/3d/' . $listing->model) }}" shadow-intensity="1" ar camera-controls
...
<script src="{{ asset('assets/customer/js/gmaps.min.js') }}"></script>
