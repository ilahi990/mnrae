                            ...
                            <div class="dl-gender-wrap d-inline-flex justify-content-between">
                                ...
                                <div class="gender-item">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input type="radio" name="type" value="sale" class="form-check-input dl-radio" id="sell"  required/><label for="sell" class="form-check-label">{{ get_phrase('Sale') }}</label>
                ...
                <div class="dl_column_form d-flex flex-column rg-22">
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-sm-10 col-md-9 col-lg-10">
                            ...
                            <input type="text" placeholder="Write postal code" class="form-control eForm-control2" id="postalcode" name="postalcode" required Value="000000"/>
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-sm-10 col-md-9 col-lg-10">
                            ...
                            <input type="text" placeholder="Provide latitude" class="form-control eForm-control2" id="latitude" name="latitude" required Value="-"/>
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-sm-10 col-md-9 col-lg-10">
                            ...
                            <input type="text" placeholder="Provide longitude" class="form-control eForm-control2" id="longitude"  name="longitude" required Value="-"/>
                            ...
                            <div class="contact-map">
                                ...
                                <div class="map-area">
                                    ...
                                    <div class="map-frame">
                                        ...
                                        <link rel="stylesheet" href="{{ asset('assets/customer/css/leaflet.css') }}" />

                                        <script src="{{ asset('assets/customer/js/leaflet.js') }}"></script>
