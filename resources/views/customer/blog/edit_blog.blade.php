            ...
            <form action="{{ route('blogUpdate', ['id' => $blog->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-21 blog-img-show">
                    ...
                    <div class="card overflow-hidden">
                        ...
                        <img  id="file-ip-1-preview" class="img-fluied" src="{{ asset('uploads/blog/'.$blog->thumbnail) }}" alt="img" name="image" >

                        @else

                        <img class="w-100" src="{{ asset('uploads/blog/placeholder.jpg') }}"
                ...
                <div class="mb-20">
                    ...
                    <div class="og_image">
                        ...
                        <img src="{{ asset('uploads/seo/'.$blog->og_image) }}" alt="....">
