       ...
       <a href="{{ route('singlePropertyView', ['slug' => $listing->slug, 'id' => $listing->id]) }}">
            ...
            <div class="product-entry">
                ...
                <div class="product-details grid_list_p">
                    ...
                    if (strlen($listing->title) < 41) { $title=$listing->title;

                        } else {

                        $title = substr($listing->title, 0, 50) . '...';
                        ...
                        if (strlen($location) < 31) { $location=$location; } else { $location=substr($location, 0, 60)

                            . '...' ; } @endphp <div class="list_price">
                            ...
                            <div>
                                ...
                                <h3 class="product-title my-0">{{ $title }}</h3>
                ...
                <div>
                    ...
                    <div class="product-location  d-flex mt-0">
