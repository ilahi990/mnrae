...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="antry-img-control row">
                                ...
                                <div class="veiw-large-slide col-lg-12">
                                    ...
                                    @forelse ($gallery as $key=> $photo)
                                        ...
                                        <div class="large-single-slide">
                                            ...
                                            <img id="bigImg"
                                                src="{{ asset('uploads/real_estate/galleryImages/' . $photo) }}"
                                                alt="image">
                                    ...
                                    @empty
                                        ...
                                        <div class="large-single-slide">
                                            ...
                                            <img id="bigImg" src="{{ get_listing_image_or_video($listing->id, 'sdas') }}"
                                                alt="image">
                                ...
                                <div class="feature-nav">
                                        ...
                                        @forelse ($gallery as $key=> $photo)
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 mb__20">
                                                ...
                                                <div class="single-small-slide">
                                                    ...
                                                    <a href="javascript:;"><img class="small_image"
                                                            src="{{ asset('uploads/real_estate/galleryImages/' . $photo) }}"
                                                            alt="image"></a>
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-6 mb__20">
                                                ...
                                                <div class="single-small-slide">
                                                    ...
                                                    <a href="javascript:;"><img
                                                            src="{{ get_listing_image_or_video($listing->id, 'sdas') }}"
                                                            alt="image"></a>
                                    ...
                                    @if (count($gallery) > 4)
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#gallary"
                                            class="more-slide"><span>+{{ count($gallery) }}
                                                {{ get_phrase('More') }}</span></a>
                                    @endif
                    ...
                    <div class="modal fade gallary-modal rel-modal" id="gallary" tabindex="-1"
                                                    ...
                                                    <defs>
                                                        ...
                                                        <clipPath id="clip0_164_10032">
                                                            ...
                                                            <rect width="30" height="29" fill="white"
                                                                transform="translate(0.404297 0.922119)" />
                                                    ...
                                                    <defs>
                                                        ...
                                                        <clipPath id="clip0_164_10027">
                                                            ...
                                                            <rect width="30" height="31" fill="white"
                                                                transform="translate(0.0917969 0.672119)" />
                                            ...
                                            <h4>
                                                ...
                                                <svg viewBox="0 0 35 34" fill="none"
                                                    ...
                                                    <defs>
                                                        ...
                                                        <filter id="filter0_d_164_10038" x="0.394531" y="0.0107422"
                                                            width="33.6445" height="33.6445" filterUnits="userSpaceOnUse"
                                                            ...
                                                            <feBlend mode="normal" in2="BackgroundImageFix"
                                                                result="effect1_dropShadow_164_10038" />

                                                            <feBlend mode="normal" in="SourceGraphic"
                                                                in2="effect1_dropShadow_164_10038" result="shape" />
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
                                                ...
                                                <div class="sing-gallary">
                                                    ...
                                                    <div class="gallary-head">
                                                        ...
                                                        <a class="veno-img"
                                                            href="{{ asset('uploads/real_estate/galleryImages/' . $photo) }}"><img
                                                                class="img-fluid"
                                                                src="{{ asset('uploads/real_estate/galleryImages/' . $photo) }}"
                                                                alt="photo"></a>
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="property-price float-end d-flex mb-3">
                            <span>{{ get_phrase('Price:') }}</span>{{ currency(number_format($listing->price)) }}
                        </div>
                                ...
                                <div class="apart-type apart-control res-apart d-flex align-items-center">
                                    ...
                                    <div class="apart-left">
                                        ...
                                        <div class="aprt-info">
                                            ...
                                            <h4 class="apt-title">
                                                {{ ucfirst($listing->category_name($listing->listing_arrtibute_type_id)) }}
                                            </h4>

                                            <span class="pro_id">{{ get_phrase('ID') }}:
                                                {{ $listing->property_id }}</span>
                                    ...
                                    <div class="apart-right d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="aprt-info appart">
                                            ...
                                            <span> {{ $listing->bedroom }} {{ get_phrase('Bedrooms') }}</span>
                                        ...
                                        <div class="aprt-info appart">
                                            ...
                                            <span>{{ $listing->area }} {{ get_phrase('Sq.ft') }}</span>
                    ...
                    <div class="row section-margin-top">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card p-overview-card details-card">
                                ...
                                <div
                                    class="apart-type address-type border-0 mt-0 d-md-flex flex-wrap justify-content-between align-items-center">

                                    <ul class="w-100 mt-0">

                                        <li>{{ get_phrase('Property ID') }} <span>{{ $listing->property_id }}</span></li>

                                        <li>{{ get_phrase('Price') }}<span>{{ currency(number_format($listing->price)) }}</span>
                                        </li>
                                        ...
                                        <li>Permit Number<span>{{ $listing->year_build_in }}</span></li>

                                        <li>{{ get_phrase('Property Type') }}<span>{{ ucfirst($listing->category_name($listing->listing_arrtibute_type_id)) }}</span>
                                        </li>

                                        <li>{{ get_phrase('Property Agent') }}<span>{{ ucfirst($listing->listings_to_user->name) }}</span>
                                        </li>
                            ...
                            <div class="card p-overview-card">
                                ...
                                <div class="sm-title  d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="{{ $url }}" target="_blank"
                                        class="btn-direction">{{ get_phrase('Get Direction') }}</a>
                                ...
                                <div
                                    ...
                                    <ul class="res-show-border mt-0">
                                        ...
                                        <li>{{ get_phrase('City') }}<span>{{ ucfirst($listing->listing_to_city->title) }}</span>
                                        </li>

                                        <li>{{ get_phrase('State') }}
                                            <span>{{ ucfirst($listing->listing_to_state->title) }}</span>
                                        </li>

                                        <li>{{ get_phrase('Country') }}
                                            <span>{{ ucfirst($listing->listing_to_city->city_to_country->name) }}</span>
                                        </li>
                                ...
                                @foreach (json_decode($listing->amenities) as $key => $amenity)
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 mb-3">
                                        ...
                                        <div class="antry-amen">
                                            ...
                                            <div class="amen-icon"><i class="{{ $amenity->font_awesome_class }}"></i>
                                            </div>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 mb-3">
                                    ...
                                    <div class="antry-amen more-amentities">
                                        ...
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                            <p class="amen-text"> {{ get_phrase('See All ') }} <i
                                                    class="fa-solid fa-arrow-right me-2"></i> </p>
                                        </a>
                    ...
                    <div class="modal rel-modal fade" id="staticBackdrop" data-bs-backdrop="static"
                        ...
                        <div class="modal-dialog modal-lg">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title fs-3" id="staticBackdropLabel">{{ get_phrase('Amenities') }}
                                    </h5>
                                    ...
                                    <div class="row">
                                        ...
                                        @foreach (json_decode($listing->amenities) as $key => $amenity)
                                            @php
                                                ...
                                                $amenity = App\Models\Listing_arrtibute_type::where(
                                                    'id',
                                                    $amenity,
                                                )->first();
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-6 mb-3">
                                                ...
                                                <div class="antry-amen">
                                                    ...
                                                    <div class="amen-icon"><i
                                                            class="{{ $amenity->font_awesome_class }}"></i></div>
                                              ...
                                              <div class="col-lg-12 floor-plan">
                                                ...
                                                <h3 class="rl-title f-28">{{ get_phrase('Floor Plans') }}</h3>
                                                    ...
                                                    @php
                                                        ...
                                                        $additional_gallery = json_decode(
                                                            $listing->additional_gallery,
                                                            true,
                                                        );
    ...
    <div class="single-floor">
                                                            ...
                                                            <a href="{{ asset('uploads/real_estate/additionalGallery/' . $photo) }}"> <img src="{{ asset('uploads/real_estate/additionalGallery/' . $photo) }}" alt="image"></a>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="antry-real-vedio video_bg">
                                            ...
                                            <video id="player" width="100%" height="300" playsinline controls>
                                                ...
                                                <source
                                                    src="{{ asset('uploads/real_estate/video/' . $listing->promo_video) }}"
                                                    type="video/mp4" />
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="3d-view w-100">
                                                ...
                                                <model-viewer
                                                    ...
                                                    src="{{ asset('assets/uploads/3d/' . $listing->model) }}"
                                                    shadow-intensity="1" ar camera-controls
                                ...
                                <div class="cl-review-head">
                                    ...
                                    <div>
                                        ...
                                        @if (isset(auth()->user()->id) != $listing->user_id)
                                            <a href="javascript:void(0)" onclick="followers()" id="followStatus">
                                                {{ get_phrase('Follow') }}</a>
                                        @else
                                            <a href="javascript:void(0)" onclick="followers('{{ $listing->user_id }}')"
                                                id="followStatus"> {{ $text }}</a>
                                        @endif



                                        <a
                                            href="{{ route('agentDetails', $listing->user_id) }}">{{ get_phrase('View Details') }}</a>
                                ...
                                <div class="rel-agent-det">
                                    ...
                                    <div class="d-flex rel-flex">
                                        ...
                                        <div class="rel-ag-text">
                                            ...
                                            <h6> <span class="fw-normal">{{ get_phrase('Listing by') }}</span>
                                                {{ $listing->listings_to_user->name }} </h6>

                                            <div class="ag-ratings">

                                                @php $summary=agent_review($listing->user_id) @endphp

                                                <span>{{ $summary['rating'] }} <i
                                                        class="fa fa-star"></i></span>({{ $summary['review'] . ' ' . get_phrase('reviews') }})
                                            ...
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <ul class="list-clear">
                                                    ...
                                                    <li>{{ get_phrase('Phone') }}:
                                                        <span>+{{ $listing->listings_to_user->phone }}</span>
                                                    </li>

                                                    <li>{{ get_phrase('Email') }}:
                                                        <span>{{ $listing->listings_to_user->email }}</span>
                                                    </li>
                                                ...
                                                <div class="ava-brand">
                                                    ...
                                                    @if ($listing->listings_to_user->company)
                                                        <img src="{{ asset('uploads/company-image/' . $listing->listings_to_user->company) }}"
                                                            alt="logo">
                                                    @else
                                                    @endif
                                    ...
                                    <div class="property-form">
                                        ...
                                        <form>
                                            ...
                                            <div class="mb-20">
                                                ...
                                                <label for="review"
                                                    class="form-label">{{ get_phrase('Your Message') }}</label>

                                                <textarea name="message" class="form-control" id="message" cols="30" rows="5"
                                                    placeholder="Type your keyword" required></textarea>

                                            </div>

                                            <button type="submit" class="btn2 btn btn-success"
                                                onclick="send_query('{{ $listing->user_id }}')">{{ get_phrase('Send') }}</button>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="client-review-area m-0" id="reviews-container">
                                ...
                                @forelse ($reviews as $index => $review)
                                    ...
                                    <div class="author-reveiw review"
                                        ...
                                        <div class="avator-box">
                                            ...
                                            <div class="left-avator">
                                                ...
                                                <div class="avator-content">
                                                    ...
                                                    <span><strong>{{ $review->rating }}</strong><i
                                                            class="fa-solid fa-star"></i>({{ timeAgo($review->created_at) }})</span>
                                        ...
                                        <div class="cl-social-share">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <a id="{{ 'like_' . $reactcounter }}" class="{{ $liked_react }}"
                                                        onclick="like_or_dislike('like',{{ $listing->id }},{{ $review->id }},{{ $reactcounter }})"
                                                    ...
                                                    <span
                                                        id="{{ 'like_count_' . $reactcounter }}">{{ count($no_of_like) }}</span>

                                                </li>

                                                <li>

                                                    <a class="{{ $disliked_react }}"
                                                        id="{{ 'dislike_' . $reactcounter }}"
                                                        onclick="like_or_dislike('dislike',{{ $listing->id }},{{ $review->id }},{{ $reactcounter }})"
                                                        href="javascript:void(0); ">
                                                    ...
                                                    <span
                                                        id="{{ 'dislike_count_' . $reactcounter }}">{{ count($no_of_dislike) }}</span>
                                ...
                                <a href="javascript:;" id="load-more"
                                    class="show_more_btn  @if (count($reviews) > 2) d-none @endif">{{ get_phrase('Show More') }}</a>
                            ...
                            @if (auth()->user())
                                @if (count($user_review_count) == 0)
                                    ...
                                    <div class="send-message-box ">
                                        ...
                                        <form action="{{ route('singlePropertyReview', ['id' => $listing->id]) }}"
                                            method="POST">
                                            ...
                                            <div class="group-form">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <label for="rating"
                                                        class="form-label">{{ get_phrase('Rating') }}</label>

                                                    <select class="form-select nice-control"
                                                        aria-label="Default select example" name="rating" id="rating"
                                                        required>

                                                        <option value="" selected>{{ get_phrase('Rating') }}
                                                        </option>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <label for="review"
                                                    class="form-label">{{ get_phrase('Review') }}</label>

                                                <textarea name="review" id="review" class="form-control" id="review" cols="30" rows="5"
                                                    placeholder="Type your keyword" required></textarea>

                                            </div>

                                            <button type="submit"
                                                class="btn2 btn btn-success">{{ get_phrase('Submit Review') }}</button>
                                ...
                                @else
                                    ...
                                    <h4 id="edit-review-sec" class="h-design f-28">{{ get_phrase('Edit Your Review') }}
                                    </h4>
                                    ...
                                    <div class="send-message-box new_form_comment antrys">
                                        ...
                                        <form action="{{ route('editlistingReview', $listing->id) }}" method="POST">
                                            ...
                                            <div class="group-form">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select nice-control"
                                                        ...
                                                        <option value="1"
                                                            @if ($user_review_count['rating'] == 1) selected @endif>1</option>

                                                        <option value="2"
                                                            @if ($user_review_count['rating'] == 2) selected @endif>2</option>

                                                        <option value="3"
                                                            @if ($user_review_count['rating'] == 3) selected @endif>3</option>

                                                        <option value="4"
                                                            @if ($user_review_count['rating'] == 4) selected @endif>4</option>

                                                        <option value="5"
                                                            @if ($user_review_count['rating'] == 5) selected @endif>5</option>
                                            ...
                                            <div class="mb-30">
                                                ...
                                                <textarea name="review" id="review" class="form-control" id="review" cols="30" rows="5"
                                                    placeholder="Type your keyword" required>{{ $user_review_count['review'] }}</textarea>

                                            </div>

                                            <button type="submit"
                                                class="btn2 btn btn-success">{{ get_phrase('Update Review') }}</button>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="share-area-btn">
                        ...
                        <div class="share-link mt-0">
                            ...
                            <a href="javascript:void(0)" id="{{ $listing->id }}"
                                class="s-heart {{ $wish_status }}  "
                                onclick="wishlist_check('<?= $listing->id ?>',this.id)">
                        ...
                        @else
                            ...
                            <a class="s-link" href="javascript:;" id="shareButton" data-bs-toggle="tooltip"
                    ...
                    <div class="rel-side-wiget">
                        ...
                        <h4 class="rl-title">{{ get_phrase('Contact with Agent') }}</h4>
                        ...
                        <form action="{{ route('customerBookAppointment') }}" method="post" class="schdule-form">
                            ...
                            {{-- <div class="schedule-date">
                                ...
                                <div class="date-select">
                                    ...
                                    <input type="text" class="form-control" id="flat" name="date"
                                        class="js-flatpickr form-control flatpickr-custom"
                                        value="{{ date('d M Y h:i a') }}" placeholder="Select dates" required>
                            ...
                            <div class="tour-type">
                                ...
                                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active mb-3" id="pills-Person-tab"
                                            href="{{ 'whatsapp://send?phone=' . $listing->listings_to_user->phone . '&text=' . urlencode('Hello, I am interested in your listing: ' . $listing->title) }}"
                                            role="tab" aria-controls="pills-Person" aria-selected="true">
                                            <i style="color: #16eb0f;" class="fa-brands fa-whatsapp"></i>
                                            {{ get_phrase('WhatsApp') }}
                                        </a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link mb-3" id="pills-Chat-tab"
                                            href="{{ 'tel:' . $listing->listings_to_user->phone }}" role="tab"
                                            aria-controls="pills-Chat" aria-selected="false">
                                            <i style="color: #1c5ce6;" class="fa-solid fa-phone"></i>
                                            {{ get_phrase('Call') }}
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <input type="hidden" id="listing_type_id" name="listing_type_id"
                                    value="{{ $listing->listing_type_id }}">


                                <h4>{{ get_phrase('For more Quries') }}</h4>
                    ...
                    <div class="related-pro-area estate-product mb-5 pb-5 row">
                        ...
                        @foreach ($related_listings as $listing_related)
                            @php
                                ...
                                $property_details = $listing_related->get_property_details(
                                    $listing_related->listing_type_id,
                                    $listing_related->id,
                                );

                                $location =
                                    ucfirst($listing_related->listing_to_city->title) .
                                    ' ,' .
                                    ucfirst($listing_related->listing_to_state->title) .
                                    ' ,' .
                                    ucfirst($listing_related->listing_to_country->name);
                            ...
                            <a class="latest_antry col-lg-4 col-md-4 col-sm-6 col-12 mb-3"
                                href="{{ route('singlePropertyView', ['slug' => $listing_related->slug, 'id' => $listing_related->id]) }}">
                                ...
                                <div class="product-entry mb-0">
                                    ...
                                    <div class="product-img">
                                        ...
                                        <img src="{{ get_listing_image_or_video($listing_related->id, $image) }}"
                                            alt="" />

                                        @php $wish_status=check_wishlist_status($listing_related->id); @endphp

                                        <span id="{{ 'grid_' . $counter }}" class="wishlist {{ $wish_status }}"
                                            onclick="wishlist_check('<?= $listing_related->id ?>','<?= $counter ?>'); return false;">
                                    ...
                                    <div class="product-details grid_list_p">
                                        ...
                                        <div class="list_price">
                                            ...
                                            <div>
                                                ...
                                                <h3 class="product-title mt-0 mb-0">
                                                    {{ Str::limit($listing_related->title, 80) }}</h3>
                                            ...
                                            <div class="antry_list_price">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="item-price-1">
                                                        {{ currency(number_format($listing_related->price)) }}</div>
                                        ...
                                        <p class="l_text">
                                            {{ Str::limit(strip_tags($listing_related->short_description), 80) }}
                                        ...
                                        <div class="product-meta d-flex justify-content-between align-items-center pb-0">
                                            ...
                                            <div class="product-meta-item">
                                                ...
                                                <img class="bed"
                                                    src="{{ asset('assets/real-estate/images/double.png') }}"
                                                    alt="">

                                                <div>

                                                    <span class="number">{{ $listing->bedroom }}</span>
                                                    {{ get_phrase('Bed') }}
                                            ...
                                            <div class="product-meta-item">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="number">{{ $listing->bathroom }}</span>
                                                    {{ get_phrase('Bat') }}
                                            ...
                                            <div class="product-meta-item">
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="number">{{ $listing->area }}</span>{{ get_phrase('Sqft') }}
