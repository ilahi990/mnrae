       ...
       <div class="row mb-4">
           ...
           <div class="col-lg-2 col-md-6 col-sm-6 col-12">
               ...
               <div class="veiw-right-item">
                   ...
                   <a class="bg-out-btn" href="{{ url()->previous() }}"><svg width="15" height="11" viewBox="0 0 15 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="antry-img-control row">
                        ...
                        <div class="veiw-large-slide col-lg-12">
                            ...
                            <div class="large-single-slide">
                                ...
                                <img  id="bigImg" src="{{ asset('uploads/real_estate/galleryImages/'.$photo) }}" alt="image">
                            ...
                            <div class="small-img-slide row justify-content-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 mb__20">
                                    ...
                                    <div class="single-small-slide">
                                        ...
                                        <a href="javascript:;"><img class="small_image" src="{{ asset('uploads/real_estate/galleryImages/'.$photo) }}" alt="image"></a>
...
@endif</h4>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
                                        ...
                                        <div class="sing-gallary">
                                            ...
                                            <div class="gallary-head">
                                                ...
                                                <a class="veno-img" href="{{ asset('uploads/real_estate/galleryImages/'.$photo) }}"><img class="img-fluid" src="{{ asset('uploads/real_estate/galleryImages/'.$photo) }}" alt="photo"></a>
               ...
               <div class="row mt-5">
                  ...
                  <div class="property-price float-end d-flex mb-3"><span>{{get_phrase('Price:')}}</span>{{currency (number_format($listing->price)) }}</div>
                            ...
                            <div class="apart-type apart-control res-apart d-flex align-items-center">
                                ...
                                <div class="apart-left">
                                    ...
                                    <div class="aprt-info">
                                        ...
                                        <h4 class="apt-title">{{ ucfirst($listing->category_name($listing->listing_arrtibute_type_id)) }}</h4>
...
{{ get_phrase('Parking') }}</span>
                      ...
                      <div class="card p-overview-card details-card">
                         ...
                         <div class="apart-type address-type border-0 mt-0 d-md-flex flex-wrap justify-content-between align-items-center">
                            ...
                            <ul class="w-100 mt-0">
                                ...
                                <li>{{ get_phrase('Price') }}<span>{{currency (number_format($listing->price)) }}</span></li>
             ...
             <div class="modal rel-modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <h5 class="modal-title fs-3" id="staticBackdropLabel">{{ get_phrase('Amenities') }}</h5>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="antry-real-vedio video_bg">
                                       ...
                                       <video id="player" width="100%" height="300" playsinline controls>
                                        ...
                                        <source src="{{ asset('uploads/real_estate/video/'. $listing->promo_video) }}" type="video/mp4" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="3d-view w-100">
                                        ...
                                        <model-viewer alt="Neil Armstrong's Spacesuit from the Smithsonian Digitization Programs Office and National Air and Space Museum" src="{{ asset('assets/uploads/3d/'.$listing->model) }}" shadow-intensity="1" ar camera-controls touch-action="pan-y"></model-viewer>
                                    ...
                                    <div class="rel-ag-text">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <div class="ava-brand">
                                                ...
                                                <img src="{{ asset('uploads/company-image/'.$listing->listings_to_user->company) }}" alt="logo">
                        ...
                        <a class="latest_antry col-lg-4 col-md-4 col-sm-6 col-12 mb-3" href="{{ route('singlePropertyView', ['slug' => $listing_related->slug, 'id' => $listing_related->id]) }}">
                            ...
                            <div class="antry_list_price">
                                ...
                                <div>
                                    ...
                                    <div class="item-price-1">{{currency (number_format($listing_related->price)) }}</div>
