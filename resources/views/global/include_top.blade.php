    ...
    <link rel="stylesheet" href="{{ asset('assets/global/font/flaticon_mycollection.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/global/css/slick-theme.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/global/css/dark.css') }}">

    <!-- VenoBox Css -->

    <link rel="stylesheet" href="{{ asset('assets/global/css/venobox.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/global/css/real_custom.css') }}">

    <!-- Responsive Css -->

    <link rel="stylesheet" href="{{ asset('assets/global/css/responsive.css') }}">
    ...
    @if (get_settings('recaptcha_status') == 1)
        ...
        <script type="application/javascript" src="{{ asset('assets/global/vendors/recaptcha/api.js') }}"></script>
    @endif
