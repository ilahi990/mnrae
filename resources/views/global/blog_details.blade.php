              ...
              <div class="col-lg-12">
                ...
                <div class="blog-details-con">
                    ...
                    <div class="l-blog-img">
                      ...
                      <img class="img-fluid" src="{{ asset('uploads/blog/'.$blog_details->thumbnail) }}" alt="image">
                    ...
                    <div class="l-blog-text">
                      ...
                      <div class="l-meta-top">
                          ...
                          <ul>
                            ...
                            <li class="d-flex align-items-center"><img src="{{ asset('assets/global/images/folder.svg') }}" alt="svg"> {{ $category_title }}</li>
                            ...
                            <li class="d-flex align-items-center"><img src="{{ asset('assets/global/images/Calendar.svg') }}" alt="svg"> <time datetime="2020-01-01">{{ $date }}</time></li>
                ...
                <a href="{{ route('blogDetails', ['slug' => slugify($latest->title), 'id' => $latest->id]) }}">
                  ...
                  <div class="widget-post-bx">
                    ...
                    <div class="widget-posts clearfix d-flex">
                      ...
                      <div class="ttr-post-media"> <img src="{{ asset('uploads/blog/'.$latest->thumbnail) }}"  alt=""> </div>
