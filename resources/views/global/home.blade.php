...
<html lang="en">
   ...
   <style>
      ...
      height: 100vh; /* Adjust this to fit your desired height */
               ...
               <div class="col-md-8 col-lg-8 col-sm-8 col-12">
                  ...
                  <div class="new_header_left">
                     ...
                     <ul class="d-flex align-items-center">
                        ...
                        <li><a href="tel:{{ get_settings('phone') }}"><i class="fa-solid fa-tty"></i>+{{ get_settings('phone') }}</a></li>
            ...
            <div class="row align-items-center">
               ...
               <div class="col-md-4 col-sm-4 col-4 col-lg-2">
                  ...
                  <div class="logo">
                     ...
                     <a href="{{ route('home') }}"><img src="{{ asset('assets/uploads/logo/' . get_frontend_settings('light_logo')) }}" alt="Logo Image"></a>

                     @else

                     <a href="{{ route('home') }}"><img src="{{ asset('assets/global/images/logo/light_logo.png') }}" alt="Logo Image"></a>
         ...
         <div class="row">
            ...
            <div class="">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-12 col-md-6 col-sm-12 mb-20 mr-10 {{ $key == 0 ? 'wow fadeInUp' : 'mt_gallary wow fadeInUp' }}" data-wow-duration="1000ms" data-wow-delay="{{ $key == 0 ? '400ms' : '450ms' }}">
            ...
            <div class="col-lg-8">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 mb-20 mr-10 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="{{ 500 + ($key - 2) * 50 }}ms">

                     <div class="Egallary {{ $key == 5 ? 'overly' : '' }}" {{ $key == 5 ? 'data-bs-toggle="modal" data-bs-target="#exampleModal"' : '' }}>
   ...
   <section class="real-estate section-padding pt-5 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="700ms">
      ...
      <div class="container">
         ...
         <div id="listing-slider" class="row">
            ...
            <a href="{{ route('singlePropertyView', ['slug' => $listing->slug, 'id' => $listing->id]) }}" style="margin-right:5px; margin-left:5px;">
                        ...
                        <div>
                           ...
                           <div class="product-location d-flex">
                              ...
                              <div>
                                 ...
                                 <div class="item-price-1">{{ currency (number_format($listing->price)) }}</div>
