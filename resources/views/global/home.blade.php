...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-1PLSKEJHBL"></script>
...
<style>
    ...
    .entry_header_control {
        ...
        height: 100vh;
        /* Adjust this to fit your desired height */
...
@php
    ...
    $banner_image = asset('assets/uploads/bannar/' . get_frontend_settings('bannar'));

    if (!file_exists('assets/uploads/bannar/' . get_frontend_settings('bannar'))) {
        $banner_image = asset('assets/global/images/banner-placeholder.svg');
    }

@endphp

<div class="entry_header_control">

    <video autoplay muted loop id="bg-video">

        <source src="https://mnr.ae/uploads/bg-vid.mp4" type="video/mp4">
                    ...
                    <div class="new_header_left">
                        ...
                        <ul class="d-flex align-items-center">
                            ...
                            <li><a href="tel:{{ get_settings('phone') }}"><i
                                        class="fa-solid fa-tty"></i>+{{ get_settings('phone') }}</a></li>

                            <li><a href="tel:971526376668"><i class="fa-solid fa-phone"></i>+971 52 637 6668</a></li>
                    ...
                    <div class="logo">
                        ...
                        @if (get_frontend_settings('light_logo'))
                            <a href="{{ route('home') }}"><img
                                    src="{{ asset('assets/uploads/logo/' . get_frontend_settings('light_logo')) }}"
                                    alt="Logo Image"></a>
                        @else
                            <a href="{{ route('home') }}"><img
                                    src="{{ asset('assets/global/images/logo/light_logo.png') }}" alt="Logo Image"></a>
                        @endif
                    ...
                    <nav class="header-menu">
                        ...
                        <ul class="primary-menu">
                            ...
                            @if (get_frontend_settings('blog_visibility_on_home_page') == 1)
                                <li><a href="{{ route('blogGrid') }}">Updates</a></li>
                            @endif
                    ...
                    <div class="col-12">
                        <div class="bannar-content text-center">
                            ...
                            <p class="wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">
                                {{ get_frontend_settings('website_subtitle') }}.
                            </p>
                        </div>
                        ...
                        <div class="bannar_drop wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <form action="{{ route('realeStateListingsFilter') }}" class="bannar-search"
                                method="get">
                                <div class="row align-items-center">
                                    <div class="col-12 col-sm-6 col-md-3 ban-col mb-3">
                                        <div class="single-search">
                                            ...
                                            <div>
                                                <select name="searched_category" class="form-select nice-control cate"
                                                    aria-label="">
                                                ...
                                                <select id="searched_price" class="form-select nice-control"
                                                    ...
                                                    @if (!empty($priceRanges))
                                                        ...
                                                        @foreach ($priceRanges as $rangeLabel)
                                                            <option value="{{ $rangeLabel }}">{{ $rangeLabel }}
                                                            </option>
                                                        @endforeach
                                                    @else
                                                    @endif
                                    ...
                                    <div class="col-12 col-sm-6 col-md-3 ban-col mb-3">
                                        <div class="single-search">
                                            <button type="submit" class="main-btn w-100">
                                                ...
                                                {{ get_phrase('Explore from listing') }}
                                            </button>
                                        </div>
                                    </div>
                                </div>
...
<div class="col-lg-3 col-md-6 col-sm-6 col-12 mb__20 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                             ...
                             <div class="single-building mr-14">
                                 ...
                                 <span>
                                     ...
                                     <img src="{{ asset('uploads/real_estate/property-image/' . $category->property_image) }}" alt="">
...
<section class="new_antrygallary wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms">
        ...
        <div class="row">
            ...
            @foreach ($states as $key => $state)
                ...
                @if ($key <= 1)
                    ...
                    <div class="col-lg-12 col-md-6 col-sm-12 mb-20 mr-10 {{ $key == 0 ? 'wow fadeInUp' : 'mt_gallary wow fadeInUp' }}"
                        data-wow-duration="1000ms" data-wow-delay="{{ $key == 0 ? '400ms' : '450ms' }}">
                        ...
                        <div class="Egallary">
                            ...
                            @if ($key == 0)
                                <div class="title_gallary">
                                    ...
                                    <h4 style="text-align: center">
                                        {{ get_frontend_settings('feature_city_subtitle') }}.</h4>

                                </div>
                            @endif

                            <div class="gallar-img {{ $key == 1 ? 'small_gallary' : '' }}">

                                <img src="{{ asset('assets/uploads/state/' . $state->thumbnail) }}" alt="image">
                            ...
                            <form id="state_form-{{ $state->id }}" method="get"
                                action="{{ route('realeStateListingsFilter') }}">

                                <input type="hidden" id="{{ $state->title }}" name="searched_states"
                                    value="{{ $state->id }}" />

                                <a href="javascript:{}" class="stretched-link"
                                    onclick="document.getElementById('state_form-{{ $state->id }}').submit();"></a>
    ...
    @if ($key >= 2)
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 mb-20 mr-10 wow fadeInUp" data-wow-duration="1000ms"
            data-wow-delay="{{ 500 + ($key - 2) * 50 }}ms">

            <div class="Egallary {{ $key == 5 ? 'overly' : '' }}"
                {{ $key == 5 ? 'data-bs-toggle="modal" data-bs-target="#exampleModal"' : '' }}>
    ...
    <div class="text-center mt-5">
        ...
        <a href="{{ route('realeStateListingsFilter') }}" class="main-btn gallary_btn">

            {{ get_phrase('See Properties') }}
...
<div class="new_g_modal">
    ...
    <div class="modal rel-modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                            ...
                            <div class="col-lg-4 mb-3">
                                ...
                                <div class="Egallary">
                                    ...
                                    <div class="gallar-img">
                                        ...
                                        <img src="{{ asset('assets/uploads/state/' . $state->thumbnail) }}"
                                            alt="image">
...
<section class="hero-area wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="700ms"
    style="background-image: url({{ asset('assets/uploads/bannar/' . get_frontend_settings('video_image')) }}); ">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 hero-icon-control">
                ...
                <div class="hero-icon">
                    ...
                    <a href="{{ get_frontend_settings('feature_video_url') }}" class="vedio-popup" id="vedio-popup"
                        data-autoplay="true" data-vbtype="video"><i class="fa-solid fa-play"></i></a>
...
<section class="real-estate section-padding pt-5 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="700ms">
    ...
    <div class="container">
        ...
        <div id="listing-slider" class="row">
            ...
            @foreach ($listings as $listing)
                @php
                    ...
                    $location =
                        ucfirst($listing->listing_to_city->title) .
                        ', ' .
                        ucfirst($listing->listing_to_state->title) .
                        ', ' .
                        ucfirst($listing->listing_to_country->name);
                        ...
                        <div class="product-details">
                                ...
                                <div>
                                    ...
                                    <div class="product-location d-flex">
                                        ...
                                        <div>
                                            ...
                                            <div class="item-price-1">{{ currency(number_format($listing->price)) }}
                                            </div>
                            ...
                            <div class="product-meta d-flex justify-content-between align-items-center">
                                ...
                                <div class="product-meta-item">
                                    ...
                                    <img class="bed" src="{{ asset('assets/real-estate/images/double.png') }}"
                                        alt="">
                                ...
                                <div class="product-meta-item">
                                    ...
                                    <div>
                                        ...
                                        <span class="number">{{ $listing->bathroom }}</span> {{ get_phrase('Bath') }}
...
<script>
    $(document).ready(function() {
        ...
        $('#listing-slider').slick({
            ...
            slidesToShow: 3, // Set the number of slides to show at once on larger screens
                          ...
                          <div class="product-details">
                              ...
                              <div class="product-meta d-flex justify-content-between align-items-center">
                                  ...
                                  <div class="product-meta-item">
                                      ...
                                      <img class="bed" src="{{ asset('assets/real-estate/images/double.png') }}" alt="">
                        ...
                        @foreach ($blogs as $blog)
                            ...
                            <div class="post-item antry-blog-post wow fadeInUp" data-wow-duration="1000ms"
                                ...
                                <div class="post-image">
                                    ...
                                    <a
                                        href="{{ route('blogDetails', ['slug' => slugify($blog->title), 'id' => $blog->id]) }}">

                                        @if ($blog->thumbnail)
                                            <img src="{{ asset('uploads/blog/' . $blog->thumbnail) }}"
                                                alt="blog-image">
                                        @else
                                            <img src="{{ asset('uploads/blog/placeholder.jpg') }}" alt="...">
                                        @endif
                                ...
                                <div class="post-content mt-3">
                                                    ...
                                                    <defs>
                                                        ...
                                                        <clipPath id="clip0_164_1319">
                                                            ...
                                                            <rect width="19" height="19" fill="white"
                                                                transform="translate(0.488281 0.290039)" />
                                                    ...
                                                    <defs>
                                                        ...
                                                        <clipPath id="clip0_180_70">
                                                            ...
                                                            <rect width="18" height="18" fill="white"
                                                                transform="translate(0.0371094 0.290039)" />
                                    ...
                                    <a href="{{ route('blogDetails', ['slug' => slugify($blog->title), 'id' => $blog->id]) }}"
                                        ...
                                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none"
                                            ...
                                            <mask id="mask0_164_1362" style="mask-type:luminance"
                                                maskUnits="userSpaceOnUse" x="6" y="0" width="10" height="17">

                                                <path d="M15.919 0.314941H6.24023V16.3149H15.919V0.314941Z"
                                                    fill="white" />
