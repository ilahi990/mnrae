...
<footer class="footer-area wow fadeInUp" data-wow-duration="500ms" data-wow-delay="100ms">
            ...
            <div class="row flex-column-reverse flex-sm-row mt-50">
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">
                    ...
                    <div class="single-footer">
                        ...
                        <a href="#"><img src="{{ asset('assets/uploads/logo/'.get_frontend_settings('footer_logo')) }}" alt=""></a>

                        @else

                        <a href="#"><img src="{{ asset('assets/global/images/logo/light_logo.png') }}" alt=""></a>
                ...
                <div class="col-lg-2 col-md-6 col-sm-6 col-12 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="700ms">
                    ...
                    <div class="single-footer">
                        ...
                        <ul class="contact ">
                            ...
                            <li><a href="tel:{{ get_settings('phone') }}" class="contact-num"><i class="fa-solid fa-tty"></i> </i>

                            <span>+{{ get_settings('phone') }}</span>

                           </a></li>

                  <li><a href="tel:+971526376668" class="contact-num"><i class="fa-solid fa-phone"></i></i>

                            <span>+971 52 637 6668</span>
