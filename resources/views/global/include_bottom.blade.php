...
<script src="{{ asset('assets/global/js/jquery.magnific-popup.min.js') }}"></script>
...
<script src="{{ asset('assets/global/js/venobox.min.js') }}"></script>
...
<script src="{{ asset('assets/global/js/embed.js') }}"></script>
