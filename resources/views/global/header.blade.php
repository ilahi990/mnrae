         ...
         <div class="col-md-4 col-sm-4 col-4 col-lg-2">
               ...
               <!-- Logo Area Start -->
                  ...
                  <div class="logo">
                     ...
                     <a href="{{ route('home') }}"><img src="{{ asset('assets/uploads/logo/'.get_frontend_settings('dark_logo')) }}" alt="Logo Image"></a>

                     @else

                     <a href="{{ route('home') }}"><img src="{{ asset('assets/global/images/logo/dark_logo.png') }}" alt="Logo Image"></a>
         ...
         <div class="col-md-8 col-lg-7 menu-items">
               ...
               <nav class="header-menu">
                  ...
                  <ul class="primary-menu">
                     ...
                     <li class="{{request()->is('blog')?'active':''}}"><a href="{{ route('blogGrid') }}">Updates</a></li>
