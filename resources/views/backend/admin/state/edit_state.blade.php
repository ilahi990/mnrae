        ...
        <div class="fpb-7 image-thum">
            ...
            <br>
                ...
                @if($state->thumbnail)
                  ...
                  <img id="thumbnail" class="img-fluied" src="{{asset('assets/uploads/state/'. $state->thumbnail)}}" name="thumbnail"/>

                @else

                   <img  id="thumbnail" class="img-fluied" src="{{asset('assets/backend/images/test-2.png')}}" alt="img" name="thumbnail" >
