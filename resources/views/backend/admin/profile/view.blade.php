        ...
        <div class="user-info d-flex flex-column">
            ...
            >
                ...
                <div class="user-graphic-element-1">
                    ...
                    <img src="{{ asset('assets/backend/images/sprial_1.png') }}" alt="" />

                </div>

                <div class="user-graphic-element-2">

                    <img src="{{ asset('assets/backend/images/polygon_1.png') }}" alt="" />

                </div>

                <div class="user-graphic-element-3">

                    <img src="{{ asset('assets/backend/images/circle_1.png') }}" alt="" />
