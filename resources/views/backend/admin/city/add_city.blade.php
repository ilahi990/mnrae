...
<form method="POST" class="d-block ajaxForm responsive_media_query form_stryle" action="{{ route('admin.AddCitiesModalPost') }}" >
    ...
    <div class="form-group row">
        ...
        <div class="fpb-7">
            ...
            <select name="state_id" id="state_id" class="form-select eForm-select eChoice-multiple-with-remove"   required>
                ...
                <option value=""> {{   get_phrase('Select a Country First'); }}
        ...
        <div class="fpb-7">
            ...
            <input type="text" class="form-control eForm-control inputDate" id="title" name="title" value="" placeholder="city name" required>
