...
<div class="eForm-layouts">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="{{ route('admin.package.create') }}">
        @csrf
        <div class="form-row">
			<div class="fpb-7">
            ...
            <div class="fpb-7">
                ...
                <select name="package_type" id="package_type" class="form-select eForm-select eChoice-multiple-with-remove">
                    ...
                    <option value="trail">{{ get_phrase('Trail') }}</option>
                </select>
            </div>
            <div class="fpb-7">
            ...
            <div class="fpb-7">
                ...
                <input type="number" min="0" class="  eForm-control" id="duration" name = "duration" placeholder="Provide number of interval " required>
            </div>
            <div class="fpb-7">
            ...
            <div class="fpb-7">
                    ...
                    <div class="row">
                        <div class="col-sm-10" id="inputContainer">
                            <input type="text" name="services[]" class="form-control eForm-control" placeholder="{{get_phrase('Write service')}}">
                        </div>
