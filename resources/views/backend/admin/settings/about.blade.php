            ...
            <div class="col-12 p-4">
                ...
                <p class="border-bottom mb-2 pb-2 text-13px">
                  ...
                  <?php else: ?>
                    ...
                    <button class="btn btn-primary float-end me-2 py-0 text-13px" onclick="rightModal('{{ route('admin.save_valid_purchase_code', ['action_type' => 'show']) }}', '{{ get_phrase('Enter valid purchase code') }}');">{{ get_phrase('Enter valid purchase code') }}</button>
                  <?php endif; ?>
                </p>
                <p class="border-bottom mb-2 pb-2 text-13px">
