                              ...
                              <div class="form-group mt-3 blog-img-show logo_imgs log_card">
                                 ...
                                 <div class="card text-center">
                                    ...
                                    @if(get_frontend_settings('light_logo'))
                                      ...
                                      <img  id="light_logo" class="img-fluied" src="{{asset('assets/uploads/logo/'.get_frontend_settings('light_logo'))}}" alt="img" name="light_logo" >

                                      @else

                                      <img  id="light_logo" class="img-fluied" src="{{asset('assets/backend/images/test-2.png')}}" alt="image" name="light_logo" >
                              ...
                              <div class="form-group mt-3 blog-img-show logo_imgs log_card">
                                 ...
                                 <div class="card text-center">
                                    ...
                                    @if(get_frontend_settings('light_logo'))
                                      ...
                                      <img  id="light_logo" class="img-fluied" src="{{asset('assets/uploads/logo/'.get_frontend_settings('dark_logo'))}}" alt="img" name="dark_logo" >

                                      @else

                                      <img  id="dark_logo" class="img-fluied" src="{{asset('assets/backend/images/test-2.png')}}" alt="image" name="dark_logo" >
                              ...
                              <div class="form-group mt-3 blog-img-show logo_imgs log_card">
                                 ...
                                 <div class="card text-center">
                                    ...
                                    @if(get_frontend_settings('favicon'))
                                      ...
                                      <img  id="favicon" class="img-fluied" src="{{asset('assets/uploads/logo/'.get_frontend_settings('favicon'))}}" alt="img" name="favicon" >

                                      @else

                                      <img  id="favicon" class="img-fluied" src="{{asset('assets/backend/images/test-2.png')}}" alt="img" name="favicon" >
                              ...
                              <div class="form-group mt-3 blog-img-show logo_imgs log_card">
                                 ...
                                 <div class="card text-center">
                                    ...
                                    @if(get_frontend_settings('footer_logo'))
                                      ...
                                      <img  id="footer_logo" class="img-fluied" src="{{asset('assets/uploads/logo/'.get_frontend_settings('footer_logo'))}}" alt="img" name="footer_logo" >

                                      @else

                                      <img  id="footer_logo" class="img-fluied" src="{{asset('assets/backend/images/test-2.png')}}" alt="img" name="footer_logo" >
                     ...
                     <div class="form-group mt-3 blog-img-show">
                          ...
                          <div class="card text-center">
                               ...
                               @if(get_frontend_settings('bannar'))
                                     ...
                                     <img id="preview" class="img-fluied" src="{{asset('assets/uploads/bannar/'. get_frontend_settings('bannar'))}}" name="bannar_image"/>

                                  @else

                                  <img  id="preview" class="img-fluied" src="{{asset('assets/backend/images/test-2.png')}}" alt="img" name="bannar_image" >
                     ...
                     <div class="form-group mt-3 blog-img-show">
                          ...
                          <div class="card text-center">
                               ...
                               @if(get_frontend_settings('video_image'))
                                     ...
                                     <img id="preview-1" class="img-fluied" src="{{asset('assets/uploads/bannar/'. get_frontend_settings('video_image'))}}" name="video_image"/>

                                  @else

                                  <img  id="preview-1" class="img-fluied" src="{{asset('assets/backend/images/test-2.png')}}" alt="img" name="video_image" >
