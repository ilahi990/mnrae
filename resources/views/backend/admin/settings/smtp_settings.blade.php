                ...
                <div class="row">
                    <div class="col-md-6 pb-3">
                        <div class="eForm-layouts">
                            <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="{{ route('admin.smtp.update') }}">
                                @csrf 
                                <div class="fpb-7">
                                ...
                                <div class="fpb-7">
                                    <label for="smtp_from_email" class="eForm-label">{{ get_phrase('Smtp from email') }}</label>
                                    <input type="text" class="form-control eForm-control" value="{{ get_settings('smtp_from_email'); }}" id="smtp_from_email" name = "smtp_from_email" required>
                                </div>
                                <div class="fpb-7">
