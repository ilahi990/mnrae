...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="logo-details mb-3">
            ...
            <div class="img_wrapper">
                ...
                @if (get_frontend_settings('light_logo'))
                    ...
                    <img height="40px" src="{{ asset('assets/uploads/logo/' . get_frontend_settings('light_logo')) }}" alt="">

                @else

                    <img height="40px" src="{{ asset('assets\global\images\logo\light_logo.png') }}" alt="">
        ...
        <ul class="nav-links">
            ...
            <li class="nav-links-li <?php if (request()->is('admin/settings/system*') || request()->is('admin/settings/website*') || request()->is('admin/settings/seo*') || request()->is('admin/payment/settings*') || request()->is('admin/map/settings*') || request()->is('admin/settings/smtp*') || request()->is('admin/settings/faq*') || request()->is('admin/contact/settings') || request()->is('admin/settings/about*') || request()->is('admin/settings/language*')) {
