...
if (! function_exists('get_user_image')) {
    ...
    function get_user_image($file_name_or_user_id = '') {
        ...
        if($user_id > 0){
            ...
            if(isset($file_name) && File::exists('uploads/user_image/'.$file_name)){

                return asset('uploads/user_image/'.$file_name);

            }else{

                return asset('uploads/user_image/no.jpg');
    ...
    function get_listing_image_or_video($listing_id,$file_name) {
        ...
        $promo_video=json_decode($list->promo_video,true);
...

           {
                ...
                return asset('uploads/real_estate/galleryImages/'.$file_name);
...

           {
                ...
                return asset('uploads/real_estate/additionalGallery/'.$file_name);
...

           {
                ...
                return asset('uploads/real_estate/promo_video/'.$file_name);
...

           {
              ...
              return asset('uploads/real_estate/placeholder.jpg');
